...
speech.text = "sorry. i can't understand your words";
...
if(message.includes("abuse")) {
  const finalText = "No! I am A kind Of Very Good Artificial intelligence. My Creator's Teach Me To Not To Give Abuse To anyone.";
  speech.text = finalText;
}
...
if(message.includes("about Muslim")) {
   document.getElementById("muslims").play();
   const finalText = "";
   speech.text = finalText;
}
